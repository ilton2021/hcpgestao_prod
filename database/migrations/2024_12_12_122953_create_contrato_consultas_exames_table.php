...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('contrato_consultas_exames', function (Blueprint $table) {
            ...
            $table->string('numero_exames'); 
            $table->string('nome_exame'); 
            $table->string('valor_unitario_consulta'); 
            $table->string('valor_unitario_exame'); 
    ...
    {
        Schema::dropIfExists('contrato_consultas_exames');
    }
};
