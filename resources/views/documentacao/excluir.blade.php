...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('destroyDocumentacao', array($unidade->id, $documentacao[0]->id)) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-control" style="color:black">
                <div class="form-row mt-3">
                    <div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
                        ...
                        <div class="col-md-8 mr-2">
                            <input class="form-control form-control-sm" type="text" id="name" name="name" value="<?php echo $documentacao[0]->nome; ?>" readonly />
                        </div>
                    </div>
                </div>
                <div class="form-row mt-2">
                    <div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
                        ...
                        <div class="col-md-8 mr-2">
                            <input type="text" class="form-control" name="arquivo" id="arquivo" value="<?php echo $documentacao[0]->arquivo; ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-row mt-2">
                    <div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
                        <div class="col-md-12 mr-2">
                            <center>
                                ...
                                <input type="submit" class="btn btn-danger btn-sm" style="margin-top: 10px;" value="Deletar" id="Salvar" name="Salvar" />
                            </center>
                        </div>
                    </div>
                </div>
