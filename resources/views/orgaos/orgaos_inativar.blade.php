...
<div class="container text-center" style="color: #28a745">Você está em: <strong>{{$unidade->name}}</strong></div><div class="container-fluid">
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 text-center">
			<h3 style="font-size: 18px;"> INATIVAR ÓRGÃO:</h3>
		</div>
	</div>
	@if ($errors->any())
		...
		<div class="col-md-12 col-sm-12 text-center">
            <div class="accordion" id="accordionExample">
                ...
                <a class="card-header bg-success text-decoration-none text-white bg-success" type="button" data-toggle="collapse" data-target="#PESSOAL" aria-expanded="true" aria-controls="PESSOAL">
				    ...
				    <form method="post" action="{{route('inativarORG', array($unidade->id, $orgaos[0]->id)) }}">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<table class="table">
                	  <thead>
						<tr> 
							<td> Nome </td>
							<td> <input type="text" id="nome" name="nome" class="form-control form-control-sm" value="<?php echo $orgaos[0]->nome; ?>" readonly /> </td>
						</tr>
						<tr>
						<td colspan="6">
					...
					<table>
						 <tr> 
                            ...
                            <td> <input hidden style="width: 100px;" type="text" id="tela" name="tela" value="alteracao_orgao" /></td>
                            <td> <input hidden style="width: 100px;" type="text" id="acao" name="acao" value="alterar_orgao" /></td>
