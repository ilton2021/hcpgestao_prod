	...
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 text-center">
			...
			<div class="d-flex justify-content-around">
				<a href="{{route('transparenciaAccountable', array($unidade->id,1))}}" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>
				<a class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('novoDC', $unidade->id)}}"> <b>Novo</b> <i class="fas fa-check"></i></a>
			</div>
		</div>
	</div>
	@if ($errors->any())
								...
								<div class="d-md-inline-flex justify-content-between border-bottom border-success align-items-center">
									...
									<div class="p-2 text-center text-nowrap">
										...
										@if($demonstrativoContabel->status_contabel == 0)
										  <a title="Ativar" class="btn btn-success btn-sm" href="{{route('telaInativarDC', array($unidade->id, $demonstrativoContabel->id))}}"><i class="fas fa-times-circle"></i></a>
										@else	
										  <a title="Inativar" class="btn btn-warning btn-sm" href="{{route('telaInativarDC', array($unidade->id, $demonstrativoContabel->id))}}"><i class="fas fa-times-circle"></i></a>
										@endif
									</div>
								</div>
								@endif
