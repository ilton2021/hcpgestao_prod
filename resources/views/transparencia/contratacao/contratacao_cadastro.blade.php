                        ...
                        <div class="card-header" id="headingThree">
                            <h2 class="mb-0">
                                ...
                                @if (Auth::check())
                                    ...
                                    <a class="btn btn-info btn-sm" style="color: #FFFFFF;"
                                        href="{{ route('contratacaoDuvidas', $unidade->id) }}"> Dúvidas <i
                                ...
                                <div class="card card-body border-0">
                                                            ...
                                                            @if ($contrato->tipo_contrato == 'OBRAS' && $contrato->tipo_pessoa == 'PESSOA FÍSICA')
                                                                <tr>
                                                                                ...
                                                                                @if ($aditivo->contrato_id == $contrato->ID)
                                                                                    ...
                                                                                    @elseif($aditivo->opcao == 3)
                                                                                            <strong><a id="div"
                                                                                                    class="dropdown-item"
                                                                                                    href="{{ asset('storage') }}/{{ $aditivo->file_path }}"
                                                                                                    target="_blank">{{ $idR }}º Rerratificação
                                                                                                    ({{ $aditivo->vinculado }})</a></strong>
                                                                                    @else
                                                                                        <?php $idC += 1; ?>
                                                                                            <strong><a id="div"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if ($contrato->inativa == 0 || $contrato-> inativa == 2)
                                    ...
                                    <div class="collapse border-0" id="obrasPessoaJuridica">
                                        <div class="card card-body border-0">
                                            <div class="container">
                                                <table class="table table-sm">
                                                <a class="btn btn-sm" href="{{ route('relatorioContratosPJ', array($unidade->id, 1)) }}"> <img src="{{asset('img/csv.png')}}" alt="" width="60" style="padding-bottom: 15px;"></a>
                                                    <thead>
                                                        <tr>
                                        ...
                                        <div class="card card-body border-0">
                                            <div class="container">
                                                <table class="table table-hover table-sm">
                                                    <a class="btn btn-sm"
                                                    href="{{ route('relatorioContratosPJ', array($unidade->id, 2)) }}"> <img src="{{asset('img/csv.png')}}" alt="" width="60" style="padding-bottom: 15px;"></a>
                                                    <thead>
                                                        <tr>
                                                            <th>ID</th>
                                                            <th scope="col">CNPJ</th>
                                ...
                                <div class="card card-body border-0">
                                    ...
                                    <div class="collapse border-0" id="aquisicaoPessoaJuridica">
                                        <div class="card card-body border-0">
                                            <div class="container">
                                                <table class="table table-sm">
                                                <a class="btn btn-sm" href="{{ route('relatorioContratosPJ', array($unidade->id, 3)) }}"> <img src="{{asset('img/csv.png')}}" alt="Logo-excel" width="60" style="padding-bottom: 15px;"></a>
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">CNPJ</th>
                                                            <th scope="col">Empresa</th>
                                                        ...
                                                        @foreach ($contratos as $contrato)
                                                            @if ($contrato->tipo_contrato == 'AQUISIÇÃO' && $contrato->tipo_pessoa == 'PESSOA JURÍDICA')
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if ($contrato->inativa == 0 || $contrato-> inativa == 2)
                                                                            <a class="btn btn-danger btn-sm" style="color: #FFFFFF;" href="{{ route('excluirContratos', [$unidade->id, $contrato->ID]) }}">
                                                                                <i class="fas fa-times-circle"></i>
                                                                            </a>
                                                                        @else
                                                                            <a class="btn btn-success btn-sm" style="color: #FFFFFF;" href="{{ route('excluirContratos', [$unidade->id, $contrato->ID]) }}">
