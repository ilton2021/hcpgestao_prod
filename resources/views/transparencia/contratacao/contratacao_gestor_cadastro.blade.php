			...
			<div class="accordion" id="accordionExample">
				...
				<form action="{{\Request::route('storeGestor'), $unidade->id}}" method="post">
					...
					<table>
						<tr>
							<td align="left">
								<br /><a href="{{route('responsavelCadastro', array($unidade->id, $id))}}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> <strong>Voltar </strong><i class="fas fa-reply"></i> </a>
