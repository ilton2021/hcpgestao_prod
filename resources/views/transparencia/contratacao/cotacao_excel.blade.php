		       ...
		       <div class="accordion" id="accordionExample">				
				   ...
				   <input type="hidden" name="_token" value="{{ csrf_token() }}">					  
					  ...
					  <table>							
					    <tr>					     
						   <td align="left">						 
						     <br /><a href="{{route('cadastroCotacoes', $unidade->id)}}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> <strong>Voltar </strong><i class="fas fa-reply"></i> </a>					           
