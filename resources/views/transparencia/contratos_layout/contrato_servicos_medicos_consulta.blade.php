...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <h3 class="text-center mt-2" style="color: #595959;">Contrato de Serviço Médico – Consultas (UPAE´s):</h3>
                    <form action="{{ route('contratoServMedCons', 2) }}" method="post">
                        @csrf
                        <div class="row m-3">
                        ...
                        <div class="row m-3">
                            <div class="col-3">
                                <label for="numero_consultas_mensais"><b>Número de Consultas Mensais (Por Extenso):</b></label>
                            </div>
                            <div class="col">
                                <textarea name="numero_consultas_mensais" id="numero_consultas_mensais" class="form form-control form-control-sm" required>{{ old('numero_consultas_mensais') }}</textarea>
                            </div>
                        </div>
                        <div class="row m-3">
                            <div class="col-3">
