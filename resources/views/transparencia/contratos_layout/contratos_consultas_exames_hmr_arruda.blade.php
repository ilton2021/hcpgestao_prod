...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <h3 class="text-center mt-2" style="color: #595959;">Contratos de Consultas e Exames – HMR e UPAE Arruda:</h3>
                    <form action="{{ route('contratoConsExamHmrArruda', 2) }}" method="post">
                        @csrf
                        <div class="row m-3">
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col">
                                <input type="text" name="especialidade_medica" id="especialidade_medica" class="form form-control form-control-sm" required value="{{ old('especialidade_medica') }}">
                            </div>
                        </div>
                        <div class="row m-3">
                            <div class="col-3">
                                <label for="numero_consultas"><b>Número de Consultas:</b></label>
                            </div>
                            <div class="col">
                                <input type="text" name="numero_consultas" id="numero_consultas" class="form form-control form-control-sm" required value="{{ old('numero_consultas') }}">
                            </div>
                        </div>
                        <div class="row m-3">
                            <div class="col-3">
                                <label for="valor_consulta"><b>Valor da Consulta:</b></label>
                            </div>
                            <div class="col">
                                <input type="text" name="valor_consulta" id="valor_consulta" class="form form-control form-control-sm" required value="{{ old('valor_consulta') }}">
                            </div>
                        </div>
                        <div class="row m-3">
                            <div class="col-3">
                        ...
                        <div class="row m-3">
                            <div class="col-3">
                                <label for="gestor_contrato"><b>Gestor do Contrato:</b></label>
                            </div>
                            <div class="col">
                                <input type="text" name="gestor_contrato" id="gestor_contrato" class="form form-control form-control-sm" required value="{{ old('gestor_contrato') }}">
                            </div>
                        </div>
                        <div class="row m-3">
                            <div class="col-3">
