	...
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 text-center">
			...
			<div class="row justify-content-around" style="margin-top: 25px;">
				<a href="{{route('transparenciaContratoGestao', array($unidade->id,1))}}" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>
				<a class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('novoCG', $unidade->id)}}"> <b>Novo</b> <i class="fas fa-check"></i> </a>
			</div>
		</div>
	</div>
	<div class="row" style="margin-top: 25px;">
						...
						<div class="d-flex flex-column justify-content-center justify-content-md-between border-bottom" id="headingOne">
							<div class="d-sm-inline-flex text-center justify-content-between">
								...
								<div class="d-inline-flex justify-content-between align-items-center">
									<div class="p-2">
										<a class="btn btn-info btn-sm" href="{{route('alterarCG', array($unidade->id, $contrato->id))}}"><i class="fas fa-edit"></i></a>
									</div>
									<div class="p-2">
