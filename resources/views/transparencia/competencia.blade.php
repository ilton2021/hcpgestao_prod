                      ...
                      <h2 class="mb-0">
                        ...
                        @foreach ($permissao_users as $permissao)
                          ...
                          @if ($permissao->unidade_id == $unidade->id)
                            <a class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('novoCP', array($unidade->id))}}" > <b>Novo</b> <i class="fas fa-check"></i></a>
                          @endif
                          @endif
                        @endforeach
                        @endif
                                ...
                                <div id="{{str_replace('/','_',str_replace(' ','_',$competenciaMatriz))}}SETORES" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample1">
                                  ...
                                  <div class="card-body border-0">
                                    ...
                                    @foreach ($competenciasMatriz as $item)
                                        ...
                                        <div class="d-sm-block table-success rounded mt-2 p-2">
                                          <div class="container">
                                            <div class="row">
                                              <div class="col-10 text-left">
                                                <p style="margin-bottom: 2px;">
                                                  @if(Auth::check())
                                                  <h4 style="font-size: 15px; margin-bottom: 5px;"><strong><a href="{{route('cadastroCP', array($unidade->id, $item->id))}}">{{$item->cargo}}</a></strong></h4>
                                                  @else
                                                  <h4 style="font-size: 15px; margin-bottom: 5px;"><strong>{{$item->cargo}}</strong></h4>
                                                  @endif
                                                </p>
                                              </div>
                                              <div class="col-2">
