...
<div class="container-fluid">
    <div class="row" style="margin-top: 25px;">
        <div class="col-md-12 text-center">
            ...
            <div class="p-2">
                <a href="{{route('cadastroRA', array($unidade->id,1))}}" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>
            </div>
        </div>
    </div>
    @if ($errors->any())
    ...
    <div class="row mt-2 form-control">
        <div class="d-flex d-flex-inline justify-content-center">
            ...
            <div class="p-2">
                <a class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('novoRADOC', $unidade->id)}}"> <b>Novo</b> <i class="fas fa-check"></i> </a></li>
            </div>
        </div>
                                            ...
                                            <div class="p-1 text-center">
                                                <a href="{{asset($AD->file_path)}}" target="_blank" class="btn btn-success btn-sm"><b>Download</b> <i class="bi bi-download"></i></a>
                                                 @if($AD->status_ass_doc == 1)
                                                  <a title="Inativar" href="{{route('telaInativarRADOC', array($unidade->id,$AD->id))}}" class="btn btn-warning btn-sm"> <i class="fas fa-times-circle"></i></a>
                                                 @else
                                                  <a title="Ativar" href="{{route('telaInativarRADOC', array($unidade->id,$AD->id))}}" class="btn btn-success btn-sm"> <i class="fas fa-times-circle"></i></a>
                                                 @endif
                                            </div>
                                        </div>
                                    </div>
