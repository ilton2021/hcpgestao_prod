...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 25px; margin-left: auto; margin-right: auto; display: flex; justify-content: center">
		<div class="col-md-10 col-sm-4 text-center">
			...
			<form method="post" action="{{ \Request::route('destroyCP'), $unidade->id }}" id="formid">
				...
				<div class="form-control mt-3" style="color:black">
					...
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-8 mr-2">
								<textarea class="form-control form-control-sm" type="textarea" readonly cols="10" rows="10" id="descricao" name="descricao" value=""><?php echo $competenciasMatriz[0]->descricao; ?></textarea>
							</div>
						</div>
					</div>
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<center>
								<h6> Deseja realmente Excluir esta Competência?? </h6>
					...
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							<div class="col-md-3 mr-4">
								...
								<input hidden type="text" class="form-control" id="acao" name="acao" value="excluirCompetencias" /> 
