	...
	<div class="row p-3">
		<div class="col-md-12 text-center">
			...
			<div class="d-flex justify-content-around">
				<a href="{{route('transparenciaDecreto', $unidade->id)}}" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>
				<a href="{{route('novoDE', $unidade->id)}}" class="btn btn-dark btn-sm" style="margin-top: 10px; color: #FFFFFF;"> <b>Novo</b> <i class="fas fa-check"></i> </a>
			</div>
		</div>
	</div>
	@if ($errors->any())
					...
					<div class="d-flex flex-column" id="headingOne">
						...
						<div class="d-md-inline-flex justify-content-between border-bottom border-success align-items-center">
							...
							<div class="d-inline-flex justify-content-sm-between align-items-center text-center">
								<div class="p-2">
									<a href="{{asset('storage/')}}/{{$decreto->path_file}}" target="_blank" class="badge badge-success"><b>Download</b> <i class="bi bi-download"></i></a>
								</div>
								<div class="p-2">
