...
<div class="container-fluid">
	...
	<div class="d-flex flex-column text-center mt-3">
		...
		<div class="d-flex justify-content-around">
			<div>
				<a href="{{route('transparenciaDemonstrative', array($unidade->id,1))}}" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>
			</div>
			<div>
				<a href="{{route('novoDF', $unidade->id)}}" class="btn btn-dark btn-sm" style="color: #FFFFFF;"> <b>Novo</b> <i class="fas fa-check"></i> </a>
			</div>
		</div>
	</div>
	...
	<div class="row" style="margin-top: 25px;">
		...
		<div class="col-md-10 col-sm-12 text-center">
			...
			<div class="collapse border border-success rounded rounded-3 m-3" id="{{$financialReport}}">
					...
					<div class="d-flex flex-column justify-content-center border-bottom border-success">
						<div class="d-md-inline-flex justify-content-between">
							...
							<div class="d-inline-flex">
								...
								<div class="p-2">
									<a class="icon-link" href="{{asset('storage')}}/{{$item->file_path}}" target="_blank"><i style="color:#65b345; font-size:25px;" class="fas fa-file-download"></i></a>
								</div>
								@elseif($item->tipoarq == 3)
								<div class="p-2">
									<a class="icon-link" href="{{$item->file_link}}" target="_blank" style="padding: 5px 5px;"><i style="color:#65b345; font-size:25px;" class="fa fa-globe"></i></a>
								</div>
								@endif
								<div class="p-2 mt-2">
									<a class="btn btn-info btn-sm" href="{{route('alterarDF', array($unidade->id, $item))}}"><i class="fas fa-edit"></i></a>
								</div>
								<div class="p-2 mt-2">
					...
					<div class="d-flex flex-column justify-content-center border-bottom border-success">
						<div class="d-md-inline-flex justify-content-between">
							...
							<div class="d-inline-flex">
								@if($item->tipoarq == 0 || $item->tipoarq == 1 || $item->tipoarq == 2)
								<div class="p-2">
									<a class="icon-link" href="{{asset('storage')}}/{{$item->file_path}}" target="_blank"><i style="color:#65b345; font-size:27px;" class="fas fa-file-download"></i></a>
								</div>
								@elseif($item->tipoarq == 3)
								<div class="p-2">
									<a class="icon-link" href="{{$item->file_link}}" target="_blank" style="padding: 5px 5px;"><i style="color:#65b345; font-size:25px;" class="fa fa-globe"></i></a>
