				...
				<div class="form-control mt-0" style="color:black">
					<div class="form-row mt-3">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-8 mr-2">
								<input class="form-control form-control-sm" type="text" id="name" name="name" value="<?php echo $manuais[0]->title; ?>" readonly />
							</div>
						</div>
					</div>
					<div class="form-row mt-1">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-8 mr-2">
								<input class="form-control form-control-sm" type="text" id="path_file" name="path_file" value="<?php echo $manuais[0]->path_file; ?>" readonly />
							</div>
						</div>
					</div>
					<div class="form-row mt-1">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-8 mr-2">
								<input class="form-control form-control-sm" type="text" id="path_img" name="path_img" value="<?php echo $manuais[0]->path_img; ?>" readonly />
							</div>
						</div>
					</div>
					<div class="form-row mt-1">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							<div class="col-md-12 mr-2">
								<center>
								<p><h6> Deseja realmente Inativar este Regulamento Próprio?? </h6></p>
						...
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							<div class="col-md-6 mr-2">
								...
								<input hidden type="text" class="form-control" id="tela" name="tela" value="regulamento" /> 
								  @if($manuais[0]->status_manuais == 0)
									<input hidden type="text" class="form-control" id="acao" name="acao" value="AtivarRegulamento" /> 
								  @else
									<input hidden type="text" class="form-control" id="acao" name="acao" value="InativarRegulamento" /> 
								  @endif
