            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    <div class="card-header" id="headingThree" style="background-color: rgb(58, 58, 58);">
                        <h3 class="mb-0">
                            <a>
                                <strong style="color:azure;">Novo Usuário</strong>
                            </a>
                        </h3>
                    </div>
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('storeUsuario') }}">
                        ...
                        <div style="margin-top:10px;margin-left:15px;margin-right:15px;" class="shadow p-3 mb-5 bg-white rounded">
                            <div class="input-group mb-3">
                                ...
                                <input style="width:1000px;height: 40px;margin-top:15px;margin-left:20px" type="text" id="name" name="name" value="{{ old('name') }}"></input>
                            </div>
                            <div class="input-group mb-3">
                                <label style="font-family:arial black;font-size:15px;margin-top:20px;margin-left:60px">E-mail:</label>
                                <input style="width:1000px;height: 40px;margin-top:15px;margin-left:20px" type="text" id="email" name="email" value="{{ old('email') }}"></input>
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <select style="width:1000px;height: 40px;margin-top:15px;margin-left:20px" value="" id="funcao" name="funcao">
                                  ...
                                  <option value="2" id="funcao" name="funcao">Ocorrências (Qualidade)</option>
                                  <option value="0" id="funcao" name="funcao">Administrador</option>
                                </select>
                            </div>
                            <div class="input-group mb-3">
                                <label style="font-family:arial black;font-size:15px;margin-top:20px;margin-left:60px">Senha:</label>
                                <input style="width:1000px;height: 40px;margin-top:15px;margin-left:20px" type="password" id=password name="password" value="{{ old('password') }}"></input>
                            </div>
                            <div class="input-group mb-3">
                                <label style="font-family:arial black;font-size:15px;margin-top:20px;margin-left:60px">Repetir Senha:</label>
                                <input style="width:1000px;height: 40px;margin-top:15px;margin-left:20px" type="password" id=password_confirmation name="password_confirmation" value="{{ old('password_confirmation') }}"></input>
                            </div>
                            <div class="input-group mb-3">
