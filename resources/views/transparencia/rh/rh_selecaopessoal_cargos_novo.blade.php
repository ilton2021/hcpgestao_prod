			...
			<div class="accordion" id="accordionExample">
				<div class="card">
					...
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
						...
						<table>
							<tr>
							  <td colspan="2" align="left"> <br /><br /> <a href="{{route('cadastroSP', $unidade->id)}}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> <strong>Voltar </strong><i class="fas fa-reply"></i> </a>
