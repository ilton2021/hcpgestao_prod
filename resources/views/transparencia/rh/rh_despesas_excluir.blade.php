		...
		<div class="col-md-12 col-sm-12 text-center">
			<div class="card">
				...
				<form action="{{route('destroyDRH', array($unidade->id, $ano, $mes, $tipo))}}" method="post">
					...
					<div class="d-flex flex-wrap justify-content-around p-2">
						<div class="p-1">
							<a href="{{route('despesasRH', array($unidade->id))}}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> <strong>Voltar </strong><i class="fas fa-reply"></i> </a>
						</div>
						<div class="p-1">
