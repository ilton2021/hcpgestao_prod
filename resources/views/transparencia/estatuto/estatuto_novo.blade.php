...
<div class="container-fluid">
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 text-center">
			<h3 style="font-size: 18px;"> CADASTRAR ESTATUTOS SOCIAL E ATAS:</h3>
		</div>
	</div>
	@if ($errors->any())
	...
	<div class="row" style="margin-top: 25px; margin-left: auto; margin-right: auto; display: flex; justify-content: center">
		<div class="col-md-10 col-sm-4 text-center">
            ...
            <form method="post" action="{{ \Request::route('storeES'), $unidade->id }}" enctype="multipart/form-data">
				...
				<div class="form-control mt-3" style="color:black">
					...
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-8 mr-2">
								<select class="form-control form-control-sm" type="number" id="year" name="year"> 
								  <?php $ano = date('Y', strtotime('now')); ?>
								  <?php for ($a = 2020; $a <= $ano; $a++) { ?>
								  	<option value="<?php echo $a ?>" <?php if($a == $ano) { echo 'selected'; } ?>>{{ $a }}</option>
								  <?php } ?>
								</select>
							</div>
						</div>
					...
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							<div class="col-md-3 mr-4">
								...
								<input hidden type="text" class="form-control" id="acao" name="acao" value="salvarEstatutoAta" /> 
