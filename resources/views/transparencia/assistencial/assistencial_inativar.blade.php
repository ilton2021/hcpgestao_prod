...
<div class="container-fluid">
	<div class="row" style="margin-bottom: 25px; margin-top: 25px;">
		<div class="col-md-12 text-center">
		  @if($anosRef[0]->status_assistencials == 0)
			<h5 style="font-size: 18px;">ATIVAR RELATÓRIO ASSISTENCIAL:</h5>
		  @else
		    <h5 style="font-size: 18px;">INATIVAR RELATÓRIO ASSISTENCIAL:</h5>
		  @endif
		</div>
	</div>
	@if ($errors->any())
	...
	<div class="d-flex flex-column">
		...
		<form action="{{\Request::route('inativarRA'), $unidade->id}}" method="post">
				...
				<table class="table table-sm ">
					...
					<table>
						<tr>
							...
							@if($anosRef[0]->status_assistencials == 0)
							<td> <input hidden type="text" class="form-control" id="acao" name="acao" value="ativarRelAssistencial" /> </td>
							@else
							<td> <input hidden type="text" class="form-control" id="acao" name="acao" value="InativarRelAssistencial" /> </td>
							@endif
			...
			<div class="mt-4 text-start">
				<h6> Deseja realmente Inativar este Relatório Assistencial?? </h6>
			</div>
			<table>
				<tr>
					<td align="left">
