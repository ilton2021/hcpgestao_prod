...
<div class="container-fluid">
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 text-center">
			<h5 style="font-size: 18px;">ALTERAR GESTORES:</h5>
		</div>
	</div>
	@if ($errors->any())
		...
		<div class="col-md-12 col-sm-12 text-center">
			<div class="accordion" id="accordionExample">
				<div class="card">
					...
					<form action="{{\Request::route('updateGE'), $unidade->id}}" method="post">
						...
						<div class="form-row mt-2">
							<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
								...
								<div class="col-md-10 mr-2">
									<input class="form-control" type="text" id="nome" name="nome" value="<?php echo $gestores[0]->nome; ?>" required />
								</div>
							</div>
						</div>
						<div class="form-row mt-2">
							<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
								...
								<div class="col-md-10 mr-2">
									<input class="form-control" type="text" id="email" name="email" value="<?php echo $gestores[0]->email; ?>" />
								</div>
							</div>
						</div>
						<div class="form-row mt-2">
							<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
								...
								<div class="col-md-10 mr-2">
									<input class="form-control" type="text" id="setor" name="setor" value="<?php echo $gestores[0]->setor; ?>" />
								</div>
							</div>
						</div>
						</div>
						<table>
							<tr>
								...
								<td> <input hidden type="text" class="form-control" id="acao" name="acao" value="alterarGestores" /> </td>
