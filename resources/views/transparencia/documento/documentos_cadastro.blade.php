	...
	<div class="row mt-3">
		...
		<div class="col-md-12 text-center">
			<div class="row justify-content-around">
				<div class="p-3">
					<a class="btn-sm btn-warning" style="color: #FFFFFF;" href="{{route('transparenciaDocumento', ['id' => $unidade->id, 'escolha' => 'CNPJ (OSS e Unidades Sob Gestão)'])}}"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>
				</div>
				<div class="p-3">
					<a href="{{route('novoDR', $unidade->id)}}" class="btn-sm btn-dark" style="color: #FFFFFF;"> <b>Novo</b> <i class="fas fa-check"></i> </a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="accordion border-0" id="accordionExample">
				<div class="card">
					<div class="card-header border-0 p-2" id="headingOne" style="padding: 0px;">
						<h6 class="mb-0">
							<a class=" text-dark no-underline" type="button" data-toggle="collapse" data-target="#{{$type->id}}" aria-expanded="true" aria-controls="{{$type->id}}" style="cursor: pointer;">
								{{$type->type_name}}
							</a>
						</h6>
					</div>
						...
						<div class="card-body d-flex flex-column justify-content-center justify-content-md-between">
							...
							<div class="d-sm-inline-flex text-sm-center flex-wrap justify-content-between">
								...
								<div class="d-inline-flex justify-content-between">
									<div class="p-1">
										<a href="{{asset('storage/')}}/{{$docs->path_file}}" target="_blank" class="badge badge-success"><b>Download</b></a>
									</div>
									<div class="p-1">
