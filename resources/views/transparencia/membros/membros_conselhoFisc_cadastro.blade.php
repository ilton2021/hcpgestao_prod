			...
			<div class="accordion" id="accordionExample">
				<div class="card">
					<div class="card-header d-flex flex-wrap justify-content-center justify-content-md-between" id="headingOne">
						...
						<h5 class="mb-0"> 
							<a href="{{route('transparenciaMembros', ['id' => $unidade->id, 'escolha' => 'Conselho fiscal'])}}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>	
							<li class="list-inline-item"><a id="Novo" name="Novo" type="button" class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('novoCF', $unidade->id)}}"> <b>Novo</b> <i class="fas fa-check"></i> </a></li>	
						</h5>
					</div>
