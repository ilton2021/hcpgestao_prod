...
<div class="container-fluid">
    ...
    <form method="POST" action="{{route('storeBP',$unidade->id)}}" enctype="multipart/form-data" id="formid">
        ...
        <div style="margin-top:5px;margin-left:15px;margin-right:15px;" class="shadow p-3 mb-4 bg-white rounded">
            <div class="d-flex flex-wrap justify-content-center">
                ...
                <div class="m-2">
                    ...
                    $s = "";
                    ?>
                    <select class="form-control" name="mes" id="mes" style="cursor: pointer;">
                ...
                <div class="m-2">
                    ...
                    $s = "";
                    ?>
                    <select class="form-control" name="ano" id="mes" style="cursor: pointer;">
            ...
            <div class="d-flex flex-wrap justify-content-center">
                <div class="m-2">
                    <label for='input-file' class="p-1 bg-info text-white rounded" style="cursor: pointer;">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center" id="containerEnviar">
        ...
        <table>
			<tr>
				...
				<td> <input hidden type="text" class="form-control" id="acao" name="acao" value="salvarBensPublicos" /> </td>
