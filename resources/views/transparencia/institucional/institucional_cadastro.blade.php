...
<div class="container-fluid">
  <div class="row mt-4">
    ...
    <div class="row mt-3 text-center">
        <div class="col-md-12">
            <a class="btn btn-warning btn-sm m-2" href="{{route('transparenciaHome', $unidade->id)}}" id="Voltar" name="Voltar" type="button" style="color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>
            <a class="btn btn-success btn-sm m-2" href="{{route('institucionalAlterar', $unidade->id)}}"> <b>Alterar</b> <i class="fas fa-edit"></i></a>
        </div>
    </div>
