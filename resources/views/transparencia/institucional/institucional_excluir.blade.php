...
<div class="container-fluid">
	...
	<div class="d-flex flex-column">
		...
		<table>
			...
			<tr>
				<td>
					<a href="{{route('institucionalCadastro', $unidade->id)}}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>
