			...
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
				<div class="form-control mt-0" style="color:black">
					...
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							<div class="col-md-12 mr-2">
								<input hidden type="text" id="unidade_id" name="unidade_id" value="<?php echo $unidade->id; ?>" /></td>
								<input hidden type="text" class="form-control" id="tela" name="tela" value="regimentoInterno" /> 
								@if($regimentos[0]->status_regimento == 0)
								<input hidden type="text" class="form-control" id="acao" name="acao" value="AtivarRegimentoInterno" /> 
								@else
								<input hidden type="text" class="form-control" id="acao" name="acao" value="InativarRegimentoInterno" /> 
								@endif
