				...
				<div class="form-control mt-0" style="color:black">
					<div class="form-row mt-3">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-8 mr-2">
								<input class="form-control form-control-sm" type="text" id="title" name="title" value="<?php echo $organograma[0]->file; ?>" readonly="true" />
							</div>
						</div>
					</div>
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-8 mr-2">
								<input class="form-control form-control-sm" type="text" id="file_path" name="file_path" readonly="true" value="<?php echo $organograma[0]->file_path; ?>" />
							</div>
						</div>
					</div>
					<div class="form-row mt-2">
					...
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							<div class="col-md-3 mr-4">
								...
								@if($organograma[0]->status_organograma == 0)
								  <input hidden type="text" class="form-control" id="acao" name="acao" value="AtivarOrganograma" /> 
								@else
								  <input hidden type="text" class="form-control" id="acao" name="acao" value="InativarOrganograma" /> 
								@endif
