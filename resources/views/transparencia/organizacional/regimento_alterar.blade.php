            ...
            <div class="form-control mt-0">
                <div class="form-row mt-3">
                    <div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
                        ...
                        <div class="col-md-8 mr-2">
                            <input class="form-control form-control-sm" type="text" id="title" name="title" value="<?php echo $regimentos[0]->title; ?>" required />
                        </div>
                    </div>
                </div>
                <div class="form-row mt-2">
                    <div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
                        ...
                        <div class="col-md-8 mr-2">
                            <input type="text" readonly class="form-control form-control-sm" name="file_path" id="file_path" value="<?php echo $regimentos[0]->file_path; ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-row mt-2">
                ...
                <div class="form-row mt-3">
                    <div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
                        <div class="col-md-6 mr-2">
                            ...
                            <input hidden type="text" class="form-control" id="acao" name="acao" value="alterarRegimentoInterno" /> 
