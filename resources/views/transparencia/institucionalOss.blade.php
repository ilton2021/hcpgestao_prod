...
<div class="container-fluid">
	...
	<div class="row p-4">
		<div class="col-md-12 text-center">
			...
			<a class="btn btn-dark btn-sm m-2" href="{{route('institucionalNovo', $undOss[0]->id)}}"> <b>Novo</b> <i class="fas fa-check"></i> </a>
			<a class="btn btn-info btn-sm m-2" href="{{route('institucionalCadastro', $undOss[0]->id)}}"> <b>Alterar</b> <i class="fas fa-edit"></i></a>
			<a class="btn btn-success btn-sm m-2" href="{{route('transparenciaInstitucionalPdf', $undOss[0]->id)}}" target="__blank"> <b>Download</b> <i class="fas fa-file-pdf"></i></a>
			@endif
			@endif
			@endforeach
			@endif
	...
	<table>
		<tr>
			<td>
				<a href="{{route('transparenciaInstitucionalPdf', $undOss[0]->id)}}" target="__blank" class="btn btn-success btn-sm" style="margin-top: 10px;"><b>Download</b> <i class="fas fa-file-pdf"></i></a>
			</td>
		</tr>
	</table>
	</form>
