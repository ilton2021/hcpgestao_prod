					...
					<div class="form-row mt-2">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							<div class="col-md-3 mr-4">
								...
								@if($relatorioFinanceiro[0]->status_financeiro == 0)
								  <input hidden type="text" class="form-control" id="acao" name="acao" value="AtivarRelatorioFinanceiro" /> 
								@else
								  <input hidden type="text" class="form-control" id="acao" name="acao" value="InativarRelatorioFinanceiro" /> 
								@endif
