  ...
  <div class="container-fluid">
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 text-center">
            ...
            <p style="margin-right: -800px;"><a href="{{route('relatorios', $unidade->id)}}" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> <strong>Voltar </strong><i class="fas fa-reply"></i> </a></p>
			<BR><BR>
		</div>
	</div>
    <table class="table">
