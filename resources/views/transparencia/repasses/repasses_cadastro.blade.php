...
<div class="container-fluid">
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 text-center">
			...
			<p align="right"><a href="{{route('transparenciaRepasses', array($unidade->id,1))}}" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a>&nbsp;&nbsp;&nbsp;<a href="{{route('novoRP', $unidade->id)}}" class="btn btn-dark btn-sm" style="color: #FFFFFF;"> <b>Novo</b> <i class="fas fa-check"></i> </a></p>
		</div>
	</div>
	@if ($errors->any())
			...
			<div class="card card-body border-0" style="background-color: #fafafa !important">
				<div class="row" style="margin-top: 25px;">
					<div class="col-md-12 col-sm-12 text-center">
						...
						<table class="table table-hover table-sm table-striped" style="font-size: 15px;">
