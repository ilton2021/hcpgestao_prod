				...
				<div class="form-control mt-0" style="color:black">
					...
					<div class="form-row mt-1">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-6 mr-2">
								<input class="form-control form-control-sm" type="text" id="contratado" name="contratado" value="<?php echo $repasses[0]->contratado; ?>" onkeyup="formatarMoeda('contratado')"/>
							</div>
						</div>
					</div>
					<div class="form-row mt-1">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-6 mr-2">
								<input class="form-control form-control-sm" type="text" id="recebido" name="recebido" value="<?php echo $repasses[0]->recebido; ?>" onkeyup="formatarMoeda('recebido')"/>
							</div>
						</div>
					</div>
					<div class="form-row mt-1">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<div class="col-md-6 mr-2">
								<input class="form-control form-control-sm" type="text" id="desconto" name="desconto" value="<?php echo $repasses[0]->desconto; ?>" onkeyup="formatarMoeda('desconto')"/>
							</div>
						</div>
					</div>
					<div class="form-row mt-1">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							<div class="col-md-12 mr-2">
								<center>
									<a href="{{route('cadastroRP', $unidade->id)}}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> <i class="fas fa-reply"></i> <b>Voltar</b> </a> </a>
					...
					<div class="form-row mt-1">
						<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
							...
							<input hidden type="text" class="form-control" id="acao" name="acao" value="alterarRepasses" /> 
