			...
			@if(Auth::check())
			 @foreach ($permissao_users as $permissao)
			  @if(($permissao->permissao_id == 15) && ($permissao->user_id == Auth::user()->id))
			    <a href="{{route('cadastroDE', $undOss[0]->id)}}" class="btn btn-info btn-sm" style="color: #FFFFFF;"> <b>Alterar</b> <i class="fas fa-edit"></i> </a>
			  @endif
			 @endforeach
			@endif
		</div>
			...
			<div class="card border-0" style="width: 25rem; background-color: #fafafa;">
				...
				<div class="card-body border-0">
					<div class="d-flex flex-column" id="headingOne">
						...
						<div class="d-md-inline-flex justify-content-between table-success border-rounded border-bottom border-success align-items-center">
							<div class="p-2">
