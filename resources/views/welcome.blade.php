                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        <ul class="list-group"> <br>
                            <li class="list-group-item border-0" style="background-color: rgba(185, 178, 178, 0);">
                                <a class="text-decoration-none" target="_blank" href="https://hcpgestao.org.br/privacidade">
                                    <p style="font-size: 20px;letter-spacing: 1px;"><font color="white">Política de Privacidade</font></p>
                                </a>
                            </li>
                            <li class="list-group-item border-0" style="background-color: rgba(185, 178, 178, 0); margin-top: 30px;">
                                <a class="text-decoration-none" href="{{ route('transparenciaOuvidoriaDenuncias', $unidade->id) }}">
                                    <p style="font-size: 20px;letter-spacing: 1px;"><font color="white">Canal de Denúncias</font></p>
                                </a>
                            </li>
                        </ul>
                    </div>
