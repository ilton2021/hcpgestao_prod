...
<body> 
    <br>
    <h3 class="text-center">Alterar Controle Documental:</h3>
    @if ($errors->any())
    ...
    @endif
    <form action="{{ route('updateDOC', array($unidade->id, $documentos[0]->id)) }}" method="post" id="formID">
        ...
        <div class="row m-2">
            <div class="col-12 col-sm-6  p-4">
                ...
                <select class="js-example-basic-single form-control form-control-sm" name="tipo_documento"
                    ...
                    <option value="Alvará" <?php if($documentos[0]->tipo_documento == "Alvará") { echo 'selected'; } ?>>Alvará</option>
                    <option value="Atestado" <?php if($documentos[0]->tipo_documento == "Atestado") { echo 'selected'; } ?>>Atestado</option>
                    <option value="Certidão" <?php if($documentos[0]->tipo_documento == "Certidão") { echo 'selected'; } ?>>Certidão</option>
                    <option value="Licença" <?php if($documentos[0]->tipo_documento == "Licença") { echo 'selected'; } ?>>Licença</option>
                </select>
                ...
                <input class="form-control form-control-sm" type="text" aria-label=".form-control-sm"
                    name="nome" id="nome" value="<?php echo $documentos[0]->nome; ?>">
                ...
                <input class="form-control form-control-sm" type="date" name="data_inicio" id="data_inicio"
                    aria-label=".form-control-sm" required value="<?php echo $documentos[0]->data_inicio; ?>">    
            </div>
            <div class="col-12 col-sm-6 p-4">
                ...
                <select class="js-example-basic-single form-control form-control-sm" name="orgao"
                    ...
                    @foreach($orgaos as $org)
                      <option value="<?php echo $org->nome; ?>" <?php if($org->nome === $documentos[0]->orgao) { echo 'selected'; } ?>>{{ $org->nome }}</option>
                    @endforeach
                </select>
                ...
                <input class="form-control form-control-sm" type="text" aria-label=".form-control-sm" name="email"
                    id="email" value="<?php echo $documentos[0]->email; ?>">
                ...
                <input class="form-control form-control-sm" type="date" aria-label=".form-control-sm"
                    name="data_fim" id="data_fim" value="<?php echo $documentos[0]->data_fim; ?>">
            </div>
