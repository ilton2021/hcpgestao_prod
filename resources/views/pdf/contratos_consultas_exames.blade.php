...
<head>
    ...
    <title>Contratos Consultas Exames</title>
...
<body class="pdf">
	...
	<table class="table-sm" style="padding: 20px;">
		...
		<tr>
            <td class="w-half">
                <p align="justify"><font size="2">Por este instrumento, <b>SOCIEDADE PERNAMBUCANA DE COMBATE AO CÂNCER – {{ $unidadeSobGestao }}</b>, pessoa jurídica de direito privado, sem fins lucrativos, inscrito no CNPJ/MF sob o nº {{ $cnpjUnidade }}, com sede na {{ $unidadeEndereco }}, neste ato representado por seu Superintendente Geral das Unidades sob Gestão, <b>Dr. Filipe Costa Leandro Bitu</b>, residente e domiciliado em Recife/PE, doravante designada simplesmente <b>CONTRATANTE</b>, e de outro, <b>{{ $nomeEmpresa }}</b>, inscrita no CNPJ/MF sob o nº {{ $cnpjEmpresa }}, localizada na {{ $enderecoEmpresa }}, neste ato por seu representante legal, nos termos de seu contrato social, a seguir denominada CONTRATADA, têm entre si justo e avençado o presente contrato de prestação de serviços médicos, que se regerá pelas cláusulas e condições postas em seguida:</font></p>
            </td>
        </tr>
		<tr>
            <td class="w-half">
	...
	<table class="table-sm" style="padding: 20px;">
		...
		<tr>
            <td>
				<p align="justify"><font size="2">2.1 Pelos serviços ora contratados, a <b>CONTRATANTE</b> pagará à <b>CONTRATADA</b> os seguintes valores:</font></p>
				<p align="justify"><font size="2">a) O valor unitário de {{ $valorUniCons }} por consulta;</font></p>
				<p align="justify"><font size="2">b) O valor unitário de {{ $valorUniExam }};</font></p>
				<p align="justify"><font size="2">2.1.1 Caso a <b>CONTRATADA</b> não atinja o número total contratado, ou realize o trabalho em menos turnos do que o efetivamente contratado, o valor será pago com desconto dos valores unitários descritos no item 2.1, acima, sem prejuízo de demais penalidades aplicadas ao caso, de igual forma, caso o número ultrapasse os efetivamente contratados, será cobrado o valor unitário excedente, conforme indicado acima.</font></p>
				...
				<p align="justify"><font size="2">2.2.3 Caso seja constatado que o contrato não foi cumprido em sua integralidade, a <b>CONTRATANTE</b> irá realizar o pagamento dos respectivos exames de acordo com o relatório, sem prejuízo de demais penalidades, caso cabível.</font></p>
				<p align="justify"><font size="2">2.3 A realização dos serviços objeto deste contrato, assim como suas respectivas contas, será acompanhada e avaliada pela Coordenação Médica e Coordenação Administrativo Financeiro, ou outras designadas pela <b>CONTRATANTE</b> para tal finalidade. A <b>CONTRATADA</b> deverá proporcionar as condições necessárias a que esse acompanhamento possa ocorrer de forma plena.</font></p>
	...
	<table class="table-sm" style="padding: 20px;">
		<tr>
			<td>
				...
				<p align="justify"><font size="2">2.6 O quantitativo mensal apresentado na Cláusula Primeira refere-se a uma demanda estimada, onde pagamento indicado no item 2.1 poderá variar de acordo com a demanda apresentada, sendo efetuado o pagamento do quantitativo efetivamente realizado pela <b>CONTRATADA</b>, levando-se em consideração o valor unitário por cada serviço, devendo a quantidade dos serviços realizados ser apurada através de relatório emitido através do sistema de controle da <b>CONTRATANTE</b>.</font></p>
			</td>
		</tr>
		<tr>
            <td class="w-half">
		...
		<tr>
            <td>
				...
				<p align="justify"><font size="2">4.7 Apresentar à <b>CONTRATANTE</b>, mensalmente ou sempre que por ela solicitado, no prazo de 10 (dez) dias úteis, certidões comprobatórias de regularidade com a Fazenda Federal, Estadual e Municipal, e certidões comprobatórias de regularidade com o Instituto Nacional do Seguro Social (INSS) e Fundo de Garantia Por Tempo de Serviço (FGTS). O não envio dessa documentação ou o envio de documento não conforme pode gerar a suspensão de pagamentos por parte da <b>CONTRATANTE</b>.</font></p>
				...
				<p align="justify"><font size="2">4.9 Os profissionais médicos utilizados pela <b>CONTRATADA</b> na prestação dos serviços deverão possuir assinatura eletrônica, digital e/ou certificado digital, compatível com os sistemas utilizados pela <b>CONTRATADA</b>.</font></p>
				...
				<p align="justify"><font size="2">4.10 Caso os profissionais utilizados pela <b>CONTRATADA</b> não atendam ao requisito acima, caberá a esta arcar imediatamente com todos os custos necessários para adequação/criação da assinatura eletrônica, digital e/ou certificado digital.</font></p>
		...
		<tr>
			<td class="w-half">
				<p align="justify"><font size="2">5.1 A <b>CONTRATADA</b> é a única e exclusiva responsável pelas obrigações tributárias, trabalhistas, sociais,  fundiárias  e  quaisquer outras	indiretamente relativas a cada um de seus associados ou empregados, que venham a prestar serviços para a <b>CONTRATANTE</b>, especialmente por possíveis reclamações trabalhistas, arcando exclusivamente com possíveis acordos e/ou condenações na Justiça do Trabalho, não cabendo à CONTRATANTE qualquer vínculo ou responsabilidade, solidária, subsidiária ou de qualquer outra natureza nesse sentido.</font></p>
		...
		<tr>
			<td class="w-half">
				<p align="justify"><font size="2">6.1 O presente contrato terá vigência pelo período de {{ date('d/m/Y', strtotime($prazoVigencia)) }} meses, contados a partir de {{ date('d/m/Y', strtotime($inicioContrato)) }}, podendo ser rescindido por qualquer das partes, a qualquer tempo, mediante por escrito, sem que em decorrência disto seja devido qualquer tipo de multa ou indenização, podendo ser renovado sucessivamente por iguais períodos por meio de aditivo contratual celebrado entre as partes.</p>
				<p align="justify"><font size="2">6.2 O presente contrato será, também, rescindido, de imediato e sem qualquer ônus adicional, na hipótese de ocorrer a rescisão ou o término de vigência do contrato de gestão firmado entre a <b>CONTRATANTE</b> e a Secretaria de Saúde.</p>
				<p align="justify"><font size="2">6.3 O presente contrato também poderá ser rescindido imediatamente pela <b>CONTRATANTE</b> diante de falta contratual grave cometida pela <b>CONTRATADA</b>, garantindo o direito ao contraditório no prazo de 3 (três) dias.</p>
		...
		<tr>
			<td class="w-half">
				<p align="justify"><font size="2">7.1 Sempre que houver necessidade no tratamento de dados pessoais as <b>PARTES</b> se obrigam a seguir os ditames da Lei 13.709 de 2018 (Lei Geral de Proteção de Dados), garantindo os meios adequados ao tratamento de dados dos titulares tanto no meio digital como no meio físico, tanto na coleta, como no armazenamento, observando as seguintes condições:</font></p>
		...
		<br><br><br>
		<tr>
            <td><center><b>Recife/PE, {{ date('d/m/Y', strtotime($dataAssinatura)) }}.</b></center></td>
        </tr>
