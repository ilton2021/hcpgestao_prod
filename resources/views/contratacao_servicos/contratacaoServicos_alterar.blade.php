            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    <div class="card-header" id="headingThree" style="background-color: #28a745!important;">
                        <h5 class="mb-0">
                            <a>
                                <strong style="color:azure;">Alterar contratação de serviço: <i class="fas fa-check-circle" aria-hidden="true"></i></strong>
                            </a>
                        </h5>
                    </div>
                    @if ($errors->any())
                    ...
                    <div class="container" style="padding: 0px;">
                        <form method="POST" action="{{route('alterarContratacao',array($CS->id,$id_und))}}" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div style="margin-top:5px; margin-left:10px; margin-right:10px;" class="shadow p-3 mb-5 bg-white rounded">
                                <div class="d-flex flex-wrap justify-content-center">
                                    <div class="m-2">
                                        <label style="font-family:Arial black, Helvetica, sans-serif;">Título:</label>
                                    </div>
                                    <div class="m-2">
                                        <input class="form-control" style="width:380px;" type="text" name="titulo" id="titulo" value="{{$CS->titulo}}" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                    </div>
                                    <div class="m-2">
                                        <label style="font-family:Arial black, Helvetica, sans-serif;">Tipo contratação:</label>
                                    </div>
                                    <div class="m-2">
                                        <select class="custom-select" style="width: 150px;" name="tipoContrata" id="tipoContrata">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-4">
                                        ...
                                        <textarea class="form-control" style="height: auto;" id=texto name="texto" aria-label="With textarea">{{$CS->texto}}</textarea>
                                ...
                                <div class="d-flex flex-wrap justify-content-center">
                                    ...
                                    <div class="m-3">
                                        <a type="submit" class="btn btn-danger" href="{{route('excluirArqContratacao', array($CS->id,$id_und))}}"><i class="fas fa-times-circle m-2"></i></a>
                                    </div>
                                    @else
                                    <div class="m-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6" style="margin-top: 20px;">
                                        <a href="{{route('paginaContratacaoServicos',$id_und)}}" class="btn btn-warning" style="color:white; font-size: 18px;"><strong>VOLTAR </strong><i class="fas fa-reply"></i></a>
                                    </div>
                                    <div class="col-md-6" style="margin-top: 20px;">
