            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    <div class="card-header" id="headingThree" style="background-color: #28a745!important;">
                        <h5 class="mb-0">
                            <a>
                                <strong style="color:azure;">Excluir contratação de serviço: <i class="fas fa-check-circle" aria-hidden="true"></i></strong>
                            </a>
                        </h5>
                    </div>
                    @if ($sucesso == "ok")
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div style="margin-top:5px; margin-left:10px; margin-right:10px;" class="shadow p-3 mb-5 bg-white rounded">
                            <div class="input-group mb-3">
                                ...
                                <textarea style="width:1000px; height: auto; margin-top:15px; margin-left:20px;" type="textarea" id=texto name="texto" rows="4" cols="50" disabled>{{$CS->texto}}</textarea>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <br>
                                <label style="font-family:arial black;font-size:15px;margin-top:20px;margin-left:60px">Arquivo:
                            ...
                            <div class="input-group mb-3">
                            <label style="font-family:arial black;font-size:15px;margin-top:20px;margin-left:60px">Especialidades: 
                            </label>
                            ...
                            <div class="d-flex m-3 flex-wrap justify-content-between">
                                <div class="m-2">
                                    <a href="{{route('paginaContratacaoServicos',$id_und)}}" class="btn btn-warning" style="color:white; font-size: 16px;"><strong>VOLTAR </strong><i class="fas fa-reply"></i></a>
                                </div>
                                <div class="m-2">
