            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    <div class="card-header" id="headingThree" style="background-color: #28a745!important;">
                        <h5 class="mb-0">
                            <a>
                                <strong style="color:azure;">Contratações de serviços: <i class="fas fa-check-circle" aria-hidden="true"></i></strong>
                            </a>
                        </h5>
                    </div>
                    @if ($errors->any())
                        ...
                        <form method="POST" action="{{route('pesquisarContratacao',$id_und)}}">
                            ...
                            <div class="container">
                                <div class="d-flex flex-wrap justify-content-center">
                                    <div class="p-1 ">
                                        <a href="{{route('transparenciaContratacao',$id_und)}}" class="btn btn-warning" style="font-size:13px;color:white;"><strong>VOLTAR </strong><i class="fas fa-reply"></i></a>
                                    </div>
                                    <div class="p-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-wrap justify-content-center">
                                        ...
                                        <div class="p-1">
                                            <a class="btn btn-info" href="{{route('pagProrrContratacao',[$CS->id,$id_und])}}"><i class="bi bi-calendar3"></i></a>
                                        </div>
                                        <div class="p-1">
                                            <a class="btn btn-dark" href="{{route('pagAlterarContratacao',[$CS->id,$id_und])}}"><i class="bi bi-pencil-square"></i></a>
                                        </div>
                                        <div class="p-1">
