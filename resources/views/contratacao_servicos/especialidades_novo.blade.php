            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    <div class="card-header" id="headingThree" style="background-color: #28a745!important;">
                        <h5 class="mb-0">
                            <a>
                                <strong style="color:azure;">Nova Especialidade Médica: <i class="fas fa-check-circle" aria-hidden="true"></i></strong>
                            </a>
                        </h5>
                    </div>
                    @if ($sucesso == "ok")
                    ...
                    <form method="POST" action="{{route('salvarEspecialidade',$id_und)}}" enctype="multipart/form-data">
                        ...
                        <div class="card-header">
                            <div class="input-group mb-3">
                                <a href="{{route('paginaEspecialidade',$id_und)}}" class="btn btn-warning" style="font-size:16px; margin-left:10px;color:white;font-family:arial"><strong>Voltar </strong><i class="fas fa-reply"></i></a>
                            </div>
                        </div>
