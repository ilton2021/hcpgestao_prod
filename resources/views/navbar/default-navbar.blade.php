    ...
    <div class="wrapper" >
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components" style="padding-top: 0px;">
                ...
                <li class="{{ (\Request::route()->getName() == 'transparenciaIntegridade') ? 'active' : '' }}">
                    <a href="{{route('transparenciaIntegridade', $unidade->id)}}" style="font-size: 10px;">CERTIFICADO DO PROGRAMA DE INTEGRIDADE</a>
                </li>
                @if(Auth::check())
                <li class="{{ (\Request::route()->getName() == 'documentacoes') ? 'active' : '' }}">
                    <a href="{{ route('documentacoes', $unidade->id) }}" style="font-size: 10px">DOCUMENTAÇÕES</a>
                </li>
                @endif
                @if(Auth::check())
                <?php $id = Auth::user()->id; ?>
                ...
                <li class="{{ (\Request::route()->getName() == 'transparenciaBensPublicos') ? 'active' : '' }}">
                    <a href="{{route('transparenciaOuvidoriaDenuncias', $unidade->id)}}" style="font-size: 10px;">CANAL DE DENÚNCIAS</a>
                </li>
                <li class="{{ (\Request::route()->getName() == 'transparenciaBensPublicos') ? 'active' : '' }}">
                    <a href="https://hcpgestao.org.br/privacidade" target="_blank" style="font-size: 10px;">POLÍTICA DE PRIVACIDADE</a>
                </li>
